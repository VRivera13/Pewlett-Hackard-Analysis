...
-- Using nicknames for Joining retirement_info and dept_emp tables
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date
...
-- Using nicknames for Joining departments and dept_manager tables
SELECT d.dept_name,
	dm.emp_no,
	dm.from_date,
	dm.to_date
...
INTO current_count_ee
FROM current_emp as ce
LEFT JOIN dept_emp as de
ON ce.emp_no = de.emp_no
GROUP BY de.dept_no
ORDER BY de.dept_no;
SELECT * from current_count_ee
...
--List of retire EEs in Sales
SELECT re.emp_no, re.first_name, re.last_name, d.dept_name
...
--List of retire EEs in Sales and Development
SELECT re.emp_no, re.first_name, re.last_name, d.dept_name
INTO retire_sales_development
FROM retirement_info as re
INNER JOIN dept_emp as de
